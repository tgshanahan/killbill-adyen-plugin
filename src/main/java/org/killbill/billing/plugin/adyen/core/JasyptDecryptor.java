...
public class JasyptDecryptor implements Decryptor {
    ...
    public JasyptDecryptor(OSGIKillbillLogService osgiKillbillLogService) {
    ...
    public JasyptDecryptor(String password, String algorithm, OSGIKillbillLogService osgiKillbillLogService) {
    ...
    protected StandardPBEStringEncryptor initializeEncryptor(String password, String algorithm) {
        ...
        if (StringUtils.isBlank(password)) {
            osgiKillbillLogService.log(LogService.LOG_ERROR, JASYPT_ENCRYPTOR_PASSWORD_KEY + " is not set");
        }
        if (StringUtils.isBlank(algorithm)) {
            osgiKillbillLogService.log(LogService.LOG_ERROR,JASYPT_ENCRYPTOR_ALGORITHM_KEY + " is not set");
        }
